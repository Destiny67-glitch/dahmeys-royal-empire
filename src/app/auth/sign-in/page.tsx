  ...
  return (
    <div style={{ backgroundColor: '#fff', minHeight: '100vh', fontFamily: 'serif', paddingBottom: '80px' }}>
      ...
      <div style={{ padding: '30px 20px', textAlign: 'center' }}>
        ...
        <p style={{ margin: '5px 0 0', fontSize: '12px', color: '#888', letterSpacing: '3px' }}>
          WOMEN'S MARKETPLACE
        </p>
      </div>
      ...
      <div style={{ margin: '0 15px 30px', padding: '50px 20px', background: 'linear-gradient(135deg, #4c1d95, #be185d)', borderRadius: '2px', color: 'white', textAlign: 'center' }}>
        <p style={{ fontSize: '12px', letterSpacing: '4px', marginBottom: '15px' }}>SIGNATURE COLLECTION</p>
        <h2 style={{ fontSize: '34px', margin: '10px 0', fontWeight: '400', lineHeight: '1.2' }}>Dress Like Royalty, <br/><i>Every Day</i></h2>
        <p style={{ fontSize: '14px', lineHeight: '1.6', opacity: 0.9, maxWidth: '280px', margin: '20px auto 0' }}>
      ...
      <div style={{ padding: '0 15px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
          {collections.map(item => (
            <div 
              key={item.id} 
              style={{ position: 'relative', cursor: 'pointer', overflow: 'hidden', height: '200px' }}
            >
